...
namespace Persistence.Migrations
{
    ...
    [Migration("20231006004442_AddStockOrderAndOrderItem")]
    partial class AddStockOrderAndOrderItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.OrderAggregate.OrderItem", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ProductAggregate.Product", "Product")
                        .WithOne("OrderItem")
                        .HasForeignKey("Domain.Entities.OrderAggregate.OrderItem", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
